...
class __TwigTemplate_266f1889346c768a890f6bd6e07eedd9affba112fc829788c2976f38cd747729 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["task"]) {
            // line 18
            echo "  <li";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, twig_template_get_attributes($this, $context["task"], "attributes", array()), "html", null, true));
            echo ">
    ";
            // line 19
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, twig_template_get_attributes($this, $context["task"], "item", array()), "html", null, true));
            echo "
    ";
            // line 20
            if (twig_template_get_attributes($this, $context["task"], "status", array())) {
                echo "<span class=\"visually-hidden\"> (";
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, twig_template_get_attributes($this, $context["task"], "status", array()), "html", null, true));
                echo ")</span>";
            }
            // line 21
            echo "  </li>
